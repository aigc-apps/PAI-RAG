"""Source-agnostic data structures exchanged between adapters and the sync loop.
...
the unified metadata schema + body that the sync loop ingests.

Ported verbatim from backend/rag/datasource/schema.py.
"""
