...
Aliyun help docs (help.aliyun.com) publish a per-product ``llms.txt`` manifest;
this adapter is the "Aliyun docs data source".
...
Ported from backend/rag/datasource/adapters/llms_txt.py.
"""
...
from app.datasource.http_util import http_get
...
class LlmsTxtAdapter(BaseAdapter):
    ...
    def validate_config(self) -> None:
        # raises ValueError when neither 'llms_url' nor 'product' is provided
        self._llms_url()
