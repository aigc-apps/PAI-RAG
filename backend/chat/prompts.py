...
- 当材料中有图片内容时，请仔细分析图片描述是否与你的回答相关，如果有相关的图片，使用Markdown格式图文混合排列输出。
...
- 每个知识库都有跟自己描述相符的知识文档，你可以按知识库名称和描述选择一个或多个对你有帮助的知识库工具。
- 生成的知识库查询应简洁明确、能够解析上下文的指代关系，并尽可能与原查询保持一致。
"""


SYNTHESIZE_PROMPT = """
现在进入对话环节，请忽略上面列出的所有工具，综合材料信息，直接回答问题，不要尝试使用任何工具。
