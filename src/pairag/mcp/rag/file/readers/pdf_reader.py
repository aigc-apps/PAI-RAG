...
from pairag.integrations.llms.pai.open_ai_alike_multi_modal import OpenAIAlikeMultiModal
...
from pairag.mcp.rag.file.utils.image_utils import compress_image_if_needed
from pairag.mcp.rag.image_caption_tool import ImageCaptionTool
from pairag.utils.modelscope_utils import init_mineru_config
