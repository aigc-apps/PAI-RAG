...
from pairag.data_pipeline.models.file.event import FileChangeType, NodeOperationType
from pairag.data_pipeline.operators.parser import get_path_resolver
...
class FileDeltaDatasource(Datasource):
    def __init__(self, config: DataSourceConfig):
        ...
        if config.enable_delta and config.target_index:
            ...
            and config.pairag_knowledgebase
        ):
            logger.info(
