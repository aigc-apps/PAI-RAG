...
from pairag.data_pipeline.utils.file_ext_utils import parse_file_extensions
...
from pairag.data_pipeline.ray_executor import ray_executor
...
def data_sink(
    ...
    pairag_token: str = typer.Option(default=None, help="Token of PAI-RAG service."),
    ...
    pairag_embed_dims: int = typer.Option(
    ...
    assert pairag_endpoint, "Please provide pairag_endpoint to ingest into."
    assert pairag_token, "Please provide pairag_token to ingest into."
    ...
    sink_config = SinkConfig(
        ...
        memory=memory,
        pairag_embed_dims=pairag_embed_dims,
        pairag_token=pairag_token,
        pairag_endpoint=pairag_endpoint,
        pairag_knowledgebase=pairag_knowledgebase,
        concurrency=concurrency,
        batch_size=batch_size,
    )
