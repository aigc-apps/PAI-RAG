...
from pairag.evaluation.pipeline.run_evaluation_pipeline import (
    run_rag_evaluation_pipeline,
)
from pairag.evaluation.pipeline.run_multimodal_evaluation_pipeline import (
...
@click.option(
    ...
    "--input_exp_config",
    show_default=True,
    default="src/pairag/config/evaluation/config.yaml",
)
