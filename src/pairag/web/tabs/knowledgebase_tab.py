...
from pairag.web.tabs.history_tab import create_upload_history
from pairag.web.tabs.chat_tab import reset_textbox, clear_history
from pairag.web.view_model import (
    RETRIEVAL_MODE_MAP,
