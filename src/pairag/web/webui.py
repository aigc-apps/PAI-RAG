...
import gradio as gr
from pairag.web import event_listeners
from pairag.web.index_utils import index_to_components_settings
from pairag.web.view_model import ViewModel
from pairag.web.rag_local_client import rag_client
from pairag.web.tabs.settings_tab import (
    create_setting_tab,
)
from pairag.web.tabs.chat_tab import create_chat_tab
from pairag.web.tabs.data_analysis_tab import create_data_analysis_tab
from pairag.web.tabs.history_tab import (
    refresh_upload_history,
)
from pairag.web.tabs.news_extension import create_news_extension_tab
from pairag.web.tabs.knowledgebase_tab import create_knowledgebase_tab
from pairag.web.tabs.search_web_tab import create_search_web_tab
...
# from pairag.web.tabs.eval_tab import create_evaluation_tab
from pairag.web.element_manager import elem_manager
from pairag.web.ui_constants import (
    DEFAULT_CSS_STYPE,
    WELCOME_MESSAGE,
)
from pairag.web.tabs.model.index_info import get_index_map
from pairag.web.filebrowser.request_utils import postprocess_middleware
