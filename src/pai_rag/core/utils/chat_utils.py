    ...
    try:
        ...
        async for chat_response in chat_response_gen:
            ...
            if 'prompt_tokens' not in chat_response.additional_kwargs:
                chat_response.additional_kwargs['prompt_tokens'] = chunk_token_usage.prompt_tokens

            if 'completion_tokens' not in chat_response.additional_kwargs:
                chat_response.additional_kwargs['completion_tokens'] = chunk_token_usage.completion_tokens

            if 'total_tokens' not in chat_response.additional_kwargs:
                chat_response.additional_kwargs['total_tokens'] = chunk_token_usage.total_tokens
