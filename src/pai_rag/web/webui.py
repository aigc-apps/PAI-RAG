...
import gradio as gr
from pai_rag.web import event_listeners
from pai_rag.web.index_utils import index_to_components_settings
from pai_rag.web.view_model import ViewModel
from pai_rag.web.rag_local_client import rag_client
from pai_rag.web.tabs.settings_tab import (
    create_setting_tab,
)
from pai_rag.web.tabs.chat_tab import create_chat_tab
from pai_rag.web.tabs.data_analysis_tab import create_data_analysis_tab
from pai_rag.web.tabs.history_tab import (
    refresh_upload_history,
)
from pai_rag.web.tabs.news_extension import create_news_extension_tab
from pai_rag.web.tabs.knowledgebase_tab import create_knowledgebase_tab
from pai_rag.web.tabs.search_web_tab import create_search_web_tab
...
# from pai_rag.web.tabs.eval_tab import create_evaluation_tab
from pai_rag.web.element_manager import elem_manager
from pai_rag.web.ui_constants import (
    DEFAULT_CSS_STYPE,
    WELCOME_MESSAGE,
)
from pai_rag.web.tabs.model.index_info import get_index_map
from pai_rag.web.filebrowser.request_utils import postprocess_middleware
...
def resume_ui():
    ...
    default_index = index_map.knowledgebases["default"]
