...
from pai_rag.integrations.llms.dashscope.utils import resolve_dashscope_credentials
...
class MyFCDashScope(FunctionCallingLLM):
    """
    DashScope LLM.
    ...
    Args:
        ...
        reuse_client: Reuse the DashScope client between requests. When doing anything with large volumes of async API calls, setting this to false can improve stability.
    ...
    api_base: str = Field(description="The base URL for DashScope API.")
