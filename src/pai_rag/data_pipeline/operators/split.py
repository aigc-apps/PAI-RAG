...
from pai_rag.data_pipeline.models.config.operator import SplitterConfig
...
from pai_rag.data_pipeline.utils.node_utils import (
    metadata_dict_to_node_v2,
    node_to_metadata_dict_v2,
)
from pai_rag.file.nodeparsers.pai.pai_node_parser import (
    NodeParserConfig,
    PaiNodeParser,
)
