...
import os
from pai_rag.data_ingestion.delta.milvus import list_docs_in_milvus_collection, list_docs_in_milvus_from_langstudio_index_manifest
...
def list_files_from_langstudio_index(
    ...
    if index_manifest.store.type == StoreType.Faiss:
        ...
        return list_docs_in_milvus_from_langstudio_index_manifest(index_manifest, oss_path_prefix)
    else:
        raise ValueError(
