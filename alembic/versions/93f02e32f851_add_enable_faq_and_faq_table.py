...
def upgrade() -> None:
    ...
    # Add faq_id column to pai_chatbot_model table
    safe_add_column('pai_chatbot_model', sa.Column('faq_id', sa.String(), nullable=True))
    ...
    op.create_index('ix_pai_chatbot_faq_faq_id', 'pai_chatbot_faq', ['faq_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_pai_chatbot_faq_faq_id', table_name='pai_chatbot_faq')
    ...
    op.drop_column('pai_chatbot_model', 'faq_id')
    # ### end Alembic commands ###
