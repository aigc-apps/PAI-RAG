...
@be_tool(
    tool_name="example",
    name="example_3_alias_name",
    desc="example_3 description",
)
def example_3(
    param_1: str = "param",
    param_2: str = Field(default="", description="param2 description"),
) -> str:
...
class OpenAIGym(TemplateTool):
    def step(
        ...
        ...
        return (Observation(content=state), reward, terminal, truncate, info)


@ActionFactory.register(
    name=GymAction.PLAY.value.name,
