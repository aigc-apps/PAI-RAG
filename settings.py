...
SNAPSHOT_FLUSH_INTERVAL_MS = _int("SNAPSHOT_FLUSH_INTERVAL_MS", 750)
...
BACKGROUND_MEMORY_REVIEW_ENABLED = _bool("BACKGROUND_MEMORY_REVIEW_ENABLED", True)
BACKGROUND_MEMORY_REVIEW_MAX_TURNS = _int("BACKGROUND_MEMORY_REVIEW_MAX_TURNS", 8)
