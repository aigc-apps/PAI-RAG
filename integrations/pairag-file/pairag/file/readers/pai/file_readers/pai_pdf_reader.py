...
from pairag.file.readers.pai.utils.modelscope_utils import (
    DEFAULT_MODEL_DIR,
    download_model_to_directory,
    init_mineru_config,
)

DEFAULT_HEADING_DIFF_THRESHOLD = 2
PDF_EXTRACTION_MODEL = "PDF-Extract-Kit-1.0"
...
class PaiPDFReader(BaseReader):
    ...
    def __init__(
        ...
        download_model_to_directory(
            model_name=PDF_EXTRACTION_MODEL, model_dir=model_dir
        )
        init_mineru_config(model_dir=model_dir)
        logger.info(
