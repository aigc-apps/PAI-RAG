...
import pytest
from pairag.file.nodeparsers.file_parser import ReaderConfig


SKIP_CONDITION = (
    not os.environ.get("OSS_ACCESS_KEY_ID") or not os.environ.get("OSS_ACCESS_KEY_SECRET")
    or not os.environ.get("MINERU_ENDPOINT") or not os.environ.get("MINERU_TOKEN")
)
...
def test_pdf_reader():
    ...
    annotate_pdf_with_chunks(pdf_file, chunks, "tests/testdata/pdf_data/mineru_iphone16_annotated.pdf")
